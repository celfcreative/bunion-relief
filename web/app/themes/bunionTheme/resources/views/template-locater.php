...
<div class="locator row vh-100 alignfull mt-0 mb-0">
  <div class="locator-left col-md-5 h-100 p-0 overflow-scroll col-12 position-relative bg-white">
    <div class="form-header p-5 pb-0">
      <form autocomplete="off" class="row gap-2 mb-2 position-relative">
        ...
        <input id="wpsl-search-btn" class="col-3 order-last me-0 ms-2 position-absolute end-0 bottom-0" type="submit" value="<?php esc_attr($wpsl->i18n->get_translation('search_btn_label', __('Search', 'wpsl'))) ?> Search">
      </form>
    ...
    <div class="form-content h-100">
      <p class="fs-6 fw-bold mb-0 ps-5 text-primary">Doctors found in your area</p>
